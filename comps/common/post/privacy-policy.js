...
export default function PrivacyPolicyPost() {
  return (
    <>
      <div className="w-full py-10 md:py-12 content">
        <div className="max-w-containers mx-auto px-3.6 w-ful">
          <div className="text-base text-black leading-8 space-y-3 md:space-y-5">
            <div className="space-y-4">
              <h2>BDA Privacy Policy</h2>
              <p>
            ...
            <div className="space-y-6">
              <h2>A. Interpretation and Definitions </h2>
              ...
              <div className="space-y-2">
                ...
                <p>
                  ...
                  "Our" in this Agreement) refers to BDATrip.
                </p>
                <p>
                ...
                <p>
                  ...
                  visit). Website refers to BDATrip, accessible from
                  https://bdatrip.com ‘You’ means the individual accessing or
            ...
            <div className="space-y-6">
              <h2>B. Collecting and Using Your Personal Data</h2>
              <div className="space-y-2">
                ...
                <h4>c. Tracking Technologies and Cookies</h4>
              ...
              <div className="space-y-2">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    reorganization, dissolution, or another sale or transfer of
            ...
            <div className="space-y-2">
              <h3>3. Retention of Your Personal Data</h3>
              <p>
              ...
              <p>
                ...
                are legally obligated to retain this data for a longer time
                period.{" "}
              </p>
            </div>

            <div className="space-y-2">
              <h3>4. Transfer of Your Personal Data</h3>
              <p>
            ...
            <div className="space-y-2">
              ...
              <div>
                <h4>c. Other legal requirements </h4>
                <p>
                  ...
                  Company Prevent or investigate possible wrongdoing in
                  connection with the Service Protect the personal safety of
                  Users of the Service or the public Protect against legal
                  liability
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                accordance with their Privacy Policies. Usage, Performance, and
                Miscellaneous We may use third-party Service Providers to
                provide better improvement of our Service. Google Places Google
                Places is a service that returns information about places using
                HTTP requests. It is operated by Google. Google Places service
                may collect information from You and from Your Device for
            ...
            <div className="space-y-2">
              <h3>D. Links to Other Websites</h3>
              <p>
            ...
            <div className="space-y-0">
              <h3 className="pb-0">F. Contact Us</h3>
              <p>
                If you have any questions about this Privacy Policy, You can
                contact us:
              </p>
              <p>
                <strong>Email:</strong> contact@bda.vn
              </p>
              <p>
                <strong>Phone:</strong> +84 (2473) 020 222
              </p>
            </div>
          </div>
        </div>
